...
console.log("The LCM of " + num1A + " and " + num1B + " is: ", lowestCommonMultiple(num1A, num1B));
console.log("The LCM of " + num2A + " and " + num2B + " is: ", lowestCommonMultiple(num2A, num2B));
console.log("The LCM of " + num3A + " and " + num3B + " is: ", lowestCommonMultiple(num3A, num3B));
console.log("The LCM of " + num4A + " and " + num4B + " is: ", lowestCommonMultiple(num4A, num4B));
console.log("The LCM of " + num5A + " and " + num5B + " is: ", lowestCommonMultiple(num5A, num5B));
